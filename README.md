...
```bash
wget -O - https://raw.githubusercontent.com/Benoitone/klippain/test_chocolatine/install.sh | bash
```
...
```bash
wget -O - https://raw.githubusercontent.com/Benoitone/klippain/test_chocolatine/uninstall.sh | bash
```
