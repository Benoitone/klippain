...
```bash
wget -O - https://raw.githubusercontent.com/Benoitone/klippain/rpi5_test/install.sh | bash
```
...
```bash
wget -O - https://raw.githubusercontent.com/Benoitone/klippain/rpi5_test/uninstall.sh | bash
```
